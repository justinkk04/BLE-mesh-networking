...
namespace {
    constexpr char TAG[]              = "MONITOR";
    constexpr int  MONITOR_INTERVAL_MS = 1000;

    TimerHandle_t monitor_timer = nullptr;
}
