...
// esp_ble_mesh_defs.h transitively includes ESP-IDF internal headers (net.h)
// that contain C99 GNU-only nested designated initializers — a hard syntax
// error in C++.  Guard the include so only C translation units see it.
// C++ callers only use the function declarations below, never the opcodes.
#ifndef __cplusplus
...
// Vendor opcodes — depend on esp_ble_mesh_defs.h; only available to C TUs.
// No C++ translation unit references these macros directly.
#ifndef __cplusplus
